# Angel Soto Perez 23270050 - 25/02/2025 - S5A
# Tecnológico de Tuxtla - Modificar la base de datos de taller para agregar las rúbricas de las diferentes áreas de conocimiento
# \. C:\ABDS5A\Practica_05\Practica05_dbtaller_23270050.sql

DROP DATABASE IF EXISTS Practica05_dbtaller_23270050;
CREATE DATABASE Practica05_dbtaller_23270050;
USE Practica05_dbtaller_23270050;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON Practica05_dbtaller_23270050.* TO 'admin'@'localhost';
GRANT SELECT, INSERT, UPDATE ON Practica05_dbtaller_23270050.Proyectos TO 'profesor'@'localhost';
GRANT SELECT, INSERT ON Practica05_dbtaller_23270050.Alumno TO 'profesor'@'localhost';
GRANT SELECT ON Practica05_dbtaller_23270050.Revisor TO 'profesor'@'localhost';
GRANT SELECT ON Practica05_dbtaller_23270050.Rubrica TO 'profesor'@'localhost';

GRANT SELECT ON Practica05_dbtaller_23270050.Proyectos TO 'alumno'@'localhost';
GRANT SELECT ON Practica05_dbtaller_23270050.Alumno TO 'alumno'@'localhost';
GRANT SELECT ON Practica05_dbtaller_23270050.Rubrica TO 'alumno'@'localhost';

GRANT SELECT, UPDATE ON Practica05_dbtaller_23270050.Revisor TO 'revisor'@'localhost';
GRANT SELECT ON Practica05_dbtaller_23270050.Proyectos TO 'revisor'@'localhost';
GRANT SELECT ON Practica05_dbtaller_23270050.Rubrica TO 'revisor'@'localhost';
